...
\begin{figure}[H]
  \centering
  \includegraphics[scale=0.15]{src/signal_gen.jpeg}
...
\begin{figure}[H]
  \centering
  \includegraphics[scale=0.15]{src/project_board.jpeg}
...
\begin{figure}[H]
  \centering
  \includegraphics[scale=0.15]{src/multimeter.jpeg}
...
\begin{figure}[H]
  \centering
  \includegraphics[scale=0.19, angle=270]{src/leds.jpeg}
  \caption{LEDs}
\end{figure}
...
\begin{figure}[H]
  \centering
  \includegraphics[scale=0.1]{src/Electronic-Axial-Lead-Resistors-Array.png}
  \caption{Resistors}
\end{figure}
...
\begin{figure}[H]
  \centering
  \includegraphics[scale=0.5]{src/circuit-1.png}
  \caption{Circuit Diagram with single LED and Resistor}
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[scale=0.5]{src/circuit-2.png}
